...
info_welcome = Welcome to Enchantmen! Visit enchantmen.com for information and example projects.
...
# Enchantmen Creator Fluent localization file (copied from Eldiron Creator)
menu_file = File
menu_new = New
menu_open = Open...
menu_save = Save...
...
status_logo_button = Open the Enchantmen Website ...
status_open_button = Open an existing Enchantmen project...
...
status_patreon_button = Visit the Enchantmen Patreon page. Thanks for your support.
status_help_button = Click on any UI element to visit the Enchantmen Online Documentation.
